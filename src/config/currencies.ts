...
// Currencies commented out below are not supported by Frankfurter (ECB data),
// which is the only free API with unlimited historical depth. Uncomment if a
// suitable historical rates source becomes available for that currency.
